...
const About: React.FC = () => {
  return (
    <section id="about" className="py-20 bg-soft-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
          
          {/* Image Side */}
          <div className="relative mb-12 lg:mb-0">
            <div className="absolute top-4 -left-4 w-full h-full bg-medical-200 rounded-3xl z-0 transform -rotate-3"></div>
            <img 
            ...
            <div className="absolute bottom-8 right-8 z-20 bg-white p-6 rounded-2xl shadow-lg max-w-xs border-l-4 border-medical-500">
              <p className="text-gray-900 font-bold text-lg mb-1">Ex-Médecin au CHU</p>
              <p className="text-medical-600 font-medium">Med 6 Marrakech</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 mb-8">
              <h4 className="flex items-center gap-2 font-bold text-gray-800 mb-4">
                <GraduationCap className="text-medical-600" />
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center">
              <a href="#contact" className="px-8 py-3 bg-medical-900 text-white rounded-full font-bold hover:bg-medical-800 transition-colors shadow-lg">
                Prendre Rendez-vous
              </a>
